...
class ResetLinkPlugin(BaseAdminPlugin):
    ...
    def block_form_bottom(self, context, nodes):
        ...
        return '<div class="text-info" style="margin-top:15px;float: left"><a href="%s"><i class="fa fa-question-sign"></i> %s</a></div>' % (reset_link, _('Forgotten your password or username?'))
